...
public class TerrainEditor : Editor
{
		...
		//Top plane
		private SerializedProperty TopPhysicsMaterial;
		...
		void OnEnable ()
		{
				...
				TopPhysicsMaterial = terrainDisplayer.FindProperty ("TopPhysicsMaterial");
		...
		public override void OnInspectorGUI ()
		{
				...
				if (topPlaneFoldout) {				
						...
						if (DrawTopMeshCollider.boolValue || DrawTopMeshRenderer.boolValue) {
								...
								EditorGUILayout.PropertyField (TopPhysicsMaterial, new GUIContent ("Physics Material", "The Physics Material that will be applyed on this plane of the mesh."));
