    ...
    public class TerrainManager
    {
        ...
        public void Generate(float endX)
        {
            ...
            while (currentTerrain.NextTerrainOrigin.x < endX)
            {
                ...
                currentTerrain = GenerateTerrainPiece(currentTerrain, currentTerrain.NextTerrainOrigin, VertexGenerator.lastY);
        ...
        public TerrainPiece GenerateTerrainPiece(TerrainPiece currentTerrain, Vector3 origin, float lastY)
        {
            ...
            nextTerrain.Create(VertexGen, origin, lastY);
            ...
            {               
                nextTerrain.Create(VertexGen, origin, VertexGenerator.lastY);
            }
